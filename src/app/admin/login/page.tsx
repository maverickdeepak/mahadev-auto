...
const supabaseUrl = "https://lxhyrchbqpgcviecqpaw.supabase.co";
// const supabaseKey = process.env.DB_API_KEY!; // Add non-null assertion
const supabase = createClient(
  supabaseUrl,
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imx4aHlyY2hicXBnY3ZpZWNxcGF3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTA1MjUyMzksImV4cCI6MjA2NjEwMTIzOX0.frE2N20bStRW7Y30kzpm1vsRgEo-nplWTDuD0I_yxkE"
);
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Sign in to manage your bike repair shop
          </p>
        </div>
